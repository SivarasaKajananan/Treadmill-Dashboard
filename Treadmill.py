...
def Continue():
    ...
    #check all values and redirect to output frame
        ...
        def output():
            ...
            global sequence
            sequence = [ImageTk.PhotoImage(img) for img in ImageSequence.Iterator(Image.open(r'running8.gif'))]
            ...
            global inc_image
            inc_image = PhotoImage(file="increase.png")
            global dec_image
            dec_image = PhotoImage(file="decrease.png")
